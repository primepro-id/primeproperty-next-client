      ...
      <TableBody>
        {agents.data.data?.data.map(a =>
          <TableRow key={a.fullname}>
            <TableCell>
              <Image
              src={a.profile_picture_url ?  env.NEXT_PUBLIC_S3_ENDPOINT + a.profile_picture_url : "/images/primepro.png"}
              alt={a.fullname}
              width={100}
              height={100}
            ...
            <TableCell>
              <div className="flex flex-col gap-1">
                ...
                <span className="flex items-center gap-1"><LuInstagram /> {a.instagram ?? "N/A"}</span>
              </div>
            </TableCell>
            <TableCell>
              <div className="flex flex-col gap-1">
            ...
            <TableCell>
              <Link href={`/admin/agents/${a.id}`} className={cn(buttonVariants({variant: "outline", size: "icon"}))}>
               <LuPen />
              </Link>
            </TableCell>
          </TableRow>
